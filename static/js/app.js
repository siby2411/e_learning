    ...
    try {
        ...
        enrollments.forEach(e => {
            ...
            div.innerHTML = `
                ...
                <div>
                    <a href="/course?enrollment=${e.id}" class="btn-sm btn-primary-sm" style="display:inline-block;padding:4px 12px;background:#1a237e;color:#fff;border-radius:4px;text-decoration:none;font-size:12px;">📖 Voir le cours</a>
                </div>
            `;
